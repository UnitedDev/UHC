...
import fr.uniteduhc.uhc.menu.options.rate.AppleRateMenu;
import fr.uniteduhc.uhc.menu.options.rate.FlintRateMenu;
import fr.uniteduhc.uhc.menu.options.rate.PearlRateMenu;
